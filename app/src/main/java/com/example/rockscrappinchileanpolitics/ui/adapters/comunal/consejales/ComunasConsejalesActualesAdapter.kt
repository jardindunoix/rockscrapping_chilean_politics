...
import com.example.rockscrappinchileanpolitics.databinding.ItemConsejalesComunasActualesBinding
...
class ComunasConsejalesActualesAdapter(
	...
	inner class MyOwnViewHolder(val binding:ItemConsejalesComunasActualesBinding):
	...
	override fun onCreateViewHolder(parent:ViewGroup, viewType:Int):BaseViewHolder<*> {
		val binding =
			ItemConsejalesComunasActualesBinding.inflate(LayoutInflater.from(context), parent, false)
