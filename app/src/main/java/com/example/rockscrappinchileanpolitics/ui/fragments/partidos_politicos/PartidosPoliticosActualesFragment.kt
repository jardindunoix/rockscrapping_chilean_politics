 ...
 * Use the [PartidosPoliticosActualesFragment.newInstance] factory method to
...
class PartidosPoliticosActualesFragment : Fragment() {
	...
	override fun onCreateView(inflater : LayoutInflater ,
		...
		return inflater.inflate(R.layout.fragment_partidos_politicos_actuales ,
		                        container ,
		                        false)
	}
	...
	companion object {
		 ...
		 * @return A new instance of fragment PartidosPoliticosActualesFragment.
		 */
		// TODO: Rename and change types and number of parameters
		@JvmStatic
		fun newInstance(param1 : String ,
		                param2 : String) =
				PartidosPoliticosActualesFragment().apply {
					arguments =
							Bundle().apply {
