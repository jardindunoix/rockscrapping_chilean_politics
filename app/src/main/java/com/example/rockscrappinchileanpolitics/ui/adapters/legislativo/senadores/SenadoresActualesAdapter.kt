package com.example.rockscrappinchileanpolitics.ui.adapters.legislativo.senadores
...
class SenadoresActualesAdapter(private var list:MutableList<SenadorActualEntity> = mutableListOf(),
	private val context:Context):RecyclerView.Adapter<SenadoresActualesAdapter.BaseViewHolder<*>>() {
